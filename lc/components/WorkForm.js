(function(){
  ...
  var WorkForm = React.createClass({displayName: "WorkForm",
    ...
    render: function(){
      ...
      return (
        React.createElement(Modal, {bsSize: "large", show: this.state.showModal, onHide: this.close}, 
          React.createElement(Modal.Header, {closeButton: true}, 
            React.createElement(Modal.Title, null, title)
          ), 
          React.createElement(Modal.Body, null, 
            React.createElement("div", {className: "form-horizontal", ref: "wrapper"}, 
              React.createElement("div", {className: "form-group"}, 
                React.createElement("label", {className: "col-sm-2 control-label"}, "姓名："), 
                React.createElement("div", {className: "col-sm-10"}, 
                  
                    isView
                    ? React.createElement("p", {className: "form-control-static", ref: "nameStatic"})
                    : React.createElement("input", {className: "form-control", type: "text", placeholder: "输入姓名", ref: "name"})
                  
                )
              ), 
              React.createElement("div", {className: "form-group"}, 
                React.createElement("label", {className: "col-sm-2 control-label"}, "小组："), 
                React.createElement("div", {className: "col-sm-10"}, 
                  
                    isView
                    ? React.createElement("p", {className: "form-control-static", ref: "departmentStatic"})
                    : (
              ...
              React.createElement("div", {className: "form-group"}, 
                React.createElement("label", {className: "col-sm-2 control-label"}, "工作类别："), 
                React.createElement("div", {className: "col-sm-10"}, 
                  
                    isView
                    ? React.createElement("p", {className: "form-control-static", ref: "workTypeStatic"})
                    : (
              ...
              React.createElement("div", {className: "form-group"}, 
                React.createElement("label", {className: "col-sm-2 control-label"}, "工作内容："), 
                React.createElement("div", {className: "col-sm-10"}, 
                  
                    isView
                    ? React.createElement("p", {className: "form-control-static", ref: "contentStatic"})
                    : React.createElement("textarea", {className: "form-control", placeholder: "输入工作内容", ref: "content"})
                ...
                React.createElement("div", {className: "form-group"}, 
                  React.createElement("div", {className: "col-sm-offset-2 col-sm-10"}, 
                    React.createElement("a", {className: "btn btn-primary", onClick: this.handleSubmit}, "提交")
                  )
                )
                )
